...
/// <summary>
/// Represents the service used to create <see cref="RedisEventStore"/> instances
/// </summary>
/// <remarks>
/// Initializes a new <see cref="RedisEventStoreFactory"/>
/// </remarks>
/// <param name="serviceProvider">The current <see cref="IServiceProvider"/></param>
public class RedisEventStoreFactory(IServiceProvider serviceProvider)
    : IFactory<RedisEventStore>
{
    ...
    /// <inheritdoc/>
    public virtual RedisEventStore Create()
    {
        ...
        return ActivatorUtilities.CreateInstance<RedisEventStore>(this.ServiceProvider, connectionMultiplexer);
    }
