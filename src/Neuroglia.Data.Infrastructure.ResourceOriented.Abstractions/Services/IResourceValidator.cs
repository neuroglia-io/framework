...
public interface IResourceValidator
{
    ...
    /// <summary>
    /// Determines whether or not the <see cref="IResourceValidator"/> applies to an operation performed on the specified resource kind
    /// </summary>
    ...
    /// <returns>A boolean indicating whether or not the <see cref="IResourceValidator"/> supports the specified resource kind</returns>
