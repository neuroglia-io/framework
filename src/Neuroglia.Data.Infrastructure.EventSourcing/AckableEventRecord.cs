    ...
    : EventRecord, IAckableEventRecord
{
    ...
    public AckableEventRecord(string streamId, string id, ulong offset, DateTimeOffset timestamp, string type, object? data = null, IDictionary<string, object>? metadata = null, Func<Task>? ackDelegate = null, Func<string?, Task>? nackDelegate = null) 
        : base(streamId, id, offset, timestamp, type, data, metadata)
    {
