...
public static class IServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddEventSourcingRepository<TAggregate, TKey>(this IServiceCollection services, Action<IEventSourcingRepositoryBuilder<TAggregate, TKey>>? setup = null, ServiceLifetime lifetime = ServiceLifetime.Scoped)
        where TAggregate : class, IAggregateRoot<TKey>
        where TKey : IEquatable<TKey>
    {
        var builder = new EventSourcingRepositoryBuilder<TAggregate, TKey>(services, lifetime);
