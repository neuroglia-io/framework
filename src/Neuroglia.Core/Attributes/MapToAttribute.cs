    ...
    : Attribute
{
    ...
    /// <summary>
    /// Initializes a new <see cref="MapToAttribute"/>
    /// </summary>
    /// <param name="destinationType">The type to which the class is mappable</param>
    public MapToAttribute(Type destinationType) { this.DestinationType = destinationType ?? throw new ArgumentNullException(nameof(destinationType)); }
