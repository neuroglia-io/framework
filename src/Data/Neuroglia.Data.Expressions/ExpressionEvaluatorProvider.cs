...
namespace Neuroglia.Data.Expressions
{
        ...
        : IExpressionEvaluatorProvider
    {
        ...
        public ExpressionEvaluatorProvider(IServiceProvider serviceProvider)
        {
        ...
        /// <inheritdoc/>
        public virtual IEnumerable<IExpressionEvaluator> GetEvaluators(string language)
        {
            return this.ServiceProvider.GetServices<IExpressionEvaluator>()
                .Where(s => s.Supports(language));
        }
