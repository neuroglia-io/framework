...
namespace Neuroglia.Data
{
        ...
        : Exception
    {
        ...
        /// <summary>
        /// Creates a new <see cref="DomainArgumentException"/> thrown when an argument is a date in the past
        /// </summary>
        /// <param name="argumentName">The name of the argument</param>
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentnull, argumentName), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentnullorwhitespace, argumentName), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentisinvalidaddress, argumentName, value), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentisinvalidemail, argumentName, value), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentisinvalidcountrycode, argumentName, value), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentisinvalidiso6391code, argumentName, value), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentisinvalidiso4217code, argumentName, value), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentisinvalidphonenumber, argumentName, value), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentisinvalidphonenumberprefix, argumentName, value), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentisinvalidtimezoneid, argumentName, value), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentisinvaliduri, argumentName, value), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentmustbehigherorlowerthan, argumentName, quantity), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentmustbehigherthan, argumentName, quantity), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentmustbehigherorequalto, argumentName, quantity), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentmustbelowerorequalto, argumentName, quantity), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentmustbeearliertimethan, argumentName, time), argumentName);
        }

        /// <summary>
        /// Creates a new <see cref="DomainArgumentException"/> for an argument that must be lower than the specified date and time
        /// </summary>
        /// <param name="argumentName">The argument's name</param>
        /// <param name="date">The date and time the argument must be lower than</param>
        /// <returns>A new <see cref="DomainArgumentException"/> for an argument that must be lower than the specified date and time</returns>
        public static DomainArgumentException ArgumentMustBeEarlierThan(string argumentName, DateTime date)
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentmustbeearlierdatetimethan, argumentName, date), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentmustbelatertimethan, argumentName, time), argumentName);
        }

        /// <summary>
        /// Creates a new <see cref="DomainArgumentException"/> for an argument that must be higher than the specified date and time
        /// </summary>
        /// <param name="argumentName">The argument's name</param>
        /// <param name="date">The date and time the argument must be higher than</param>
        /// <returns>A new <see cref="DomainArgumentException"/> for an argument that must be higher than the specified date and time</returns>
        public static DomainArgumentException ArgumentMustBeLaterThan(string argumentName, DateTime date)
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentmustbelaterdatetimethan, argumentName, date), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentmusthaveminimumlengthof, length), argumentName);
        }
        ...
        {
            return new DomainArgumentException(StringExtensions.Format(LocalizedResources.exception_domain_argumentmusthavemaximumlengthof, length), argumentName);
        }
        ...
        {
            return new DomainException(StringExtensions.Format(LocalizedResources.exception_domain_deletionnotsupported, entityType.Name));
        }
        ...
        {
            return new DomainException(StringExtensions.Format(LocalizedResources.exception_domain_entityalreadyexists, entityTypeName, keyProperty.Slugify(" ", true), key));
        }
        ...
        {
            return new DomainException(StringExtensions.Format(LocalizedResources.exception_domain_entityalreadyexists_many, entityTypeName, string.Join(", ", properties.Select(p => p.Slugify(" ", true)))));
        }
        ...
        {
            return new DomainException(StringExtensions.Format(LocalizedResources.exception_domain_filteringnotallowed, entityType.Name));
        }
        ...
        {
            return new DomainException(StringExtensions.Format(LocalizedResources.exception_domain_invalidcast, from.Name, to.Name));
        }
        ...
        {
            return new DomainException(StringExtensions.Format(LocalizedResources.exception_domain_missingproperty, property, type.Name));
        }
        ...
        {
            return new DomainException(StringExtensions.Format(LocalizedResources.exception_domain_notsupported, typeName, value));
        }
        ...
        {
            return new DomainNullReferenceException(StringExtensions.Format(LocalizedResources.exception_domain_nullreference, entityTypeName, keyProperty.Slugify(" ", true), key));
        }
        ...
        {
            return new DomainNullReferenceException(StringExtensions.Format(LocalizedResources.exception_domain_nullreference_many, entityTypeName, Environment.NewLine + string.Join(Environment.NewLine, keyValues.Select(kvp => $"{kvp.Key}: '{kvp.Value}'"))));
        }
        ...
        {
            return new DomainException(StringExtensions.Format(LocalizedResources.exception_domain_unexpectedstate, entityType.Name, keyProperty, key.ToString(), state.ToString()));
        }
        ...
        {
            return new DomainException(StringExtensions.Format(LocalizedResources.exception_domain_unexpectedvalue, entityType.Name, keyProperty, key.ToString(), valueProperty, value.ToString()));
        }
        ...
        public static DomainValidationException ValidationFailed(params Error[] errors)
        {
