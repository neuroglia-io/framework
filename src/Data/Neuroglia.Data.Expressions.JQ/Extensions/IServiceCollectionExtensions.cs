...
namespace Neuroglia.Data.Expressions.JQ
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddJQExpressionEvaluator(this IServiceCollection services, Action<IJQExpressionEvaluatorOptionsBuilder> setup, ServiceLifetime lifetime = ServiceLifetime.Transient)
        {
        ...
        {
            return services.AddJQExpressionEvaluator(_ => { }, lifetime);
        }
