using Neuroglia.Data.Properties;
    ...
    : Exception
{
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentcannotbeadateinthefuture, argumentName), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentnull, argumentName), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentnullorwhitespace, argumentName), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentisinvalidaddress, argumentName, value), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentisinvalidemail, argumentName, value), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentisinvalidcountrycode, argumentName, value), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentisinvalidiso6391code, argumentName, value), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentisinvalidiso4217code, argumentName, value), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentisinvalidphonenumber, argumentName, value), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentisinvalidphonenumberprefix, argumentName, value), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentisinvalidtimezoneid, argumentName, value), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentisinvaliduri, argumentName, value), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentisunsupportedvalue, argumentName, value, string.Join(", ", supportedValues)), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentmustbehigherorlowerthan, argumentName, quantity), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentmustbelowerorhigherthan, argumentName, quantity), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentmustbehigherthan, argumentName, quantity), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentmustbehigherorequalto, argumentName, quantity), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentmustbelowerorequalto, argumentName, quantity), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentmustbeearlierthan, argumentName, time), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentmustbelaterthan, argumentName, time), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentmustbelaterthan, argumentName, date), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentmusthaveminimumlengthof, length), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentmusthavemaximumlengthof, length), argumentName);
    }
    ...
    {
        return new DomainArgumentException(StringFormatter.Format(LocalizedResources.exception_domain_argumentmustbecomprisedbetweenincluding, argumentName, min, max), argumentName);
    }
    ...
    {
        return new DomainArgumentException(LocalizedResources.exception_domain_argumentmustbenumeric, argumentName);
    }
    ...
    {
        return new DomainException(StringFormatter.Format(LocalizedResources.exception_domain_deletionnotsupported, entityType.Name));
    }
    ...
    public static DomainException EntityAlreadyExists(Type entityType, object key, string keyProperty = "id") => EntityAlreadyExists(entityType.Name, key, keyProperty);
    ...
    {
        return new DomainException(StringFormatter.Format(LocalizedResources.exception_domain_entityalreadyexists, entityTypeName, keyProperty, key));
    }
    ...
    /// <returns>A new <see cref="DomainException"/> fired whenever an entity of the specified type already exists</returns>
    public static DomainException EntityAlreadyExists(Type entityType, string[] properties) => EntityAlreadyExists(entityType.Name, properties);
    ...
    {
        return new DomainException(StringFormatter.Format(LocalizedResources.exception_domain_entityalreadyexists_many, entityTypeName, string.Join(", ", properties.Select(p => p))));
    }
    ...
    {
        return new DomainException(StringFormatter.Format(LocalizedResources.exception_domain_filteringnotallowed, entityType.Name));
    }
    ...
    {
        return new DomainException(StringFormatter.Format(LocalizedResources.exception_domain_invalidcast, from.Name, to.Name));
    }
    ...
    {
        return new DomainException(StringFormatter.Format(LocalizedResources.exception_domain_missingproperty, property, type.Name));
    }
    ...
    public static DomainException NotSupported(Type type, object value) => NotSupported(type.Name, value);
    ...
    {
        return new DomainException(StringFormatter.Format(LocalizedResources.exception_domain_notsupported, typeName, value));
    }
    ...
    public static DomainNullReferenceException NullReference(Type entityType, object key, string keyProperty = "id") => NullReference(entityType.Name, key, keyProperty);
    ...
    {
        return new DomainNullReferenceException(StringFormatter.Format(LocalizedResources.exception_domain_nullreference, entityTypeName, keyProperty, key));
    }
    ...
    /// <returns>A new <see cref="DomainException"/> thrown when an entity of the specified type has not been found</returns>
    public static DomainNullReferenceException NullReference(Type entityType, params KeyValuePair<string, object>[] keyValues) => NullReference(entityType.Name, keyValues);
    ...
    {
        return new DomainNullReferenceException(StringFormatter.Format(LocalizedResources.exception_domain_nullreference_many, entityTypeName, Environment.NewLine + string.Join(Environment.NewLine, keyValues.Select(kvp => $"{kvp.Key}: '{kvp.Value}'"))));
    }
    ...
    {
        return new DomainException(StringFormatter.Format(LocalizedResources.exception_domain_unexpectedstate, entityType.Name, keyProperty, key, state));
    }
    ...
    {
        return new DomainException(StringFormatter.Format(LocalizedResources.exception_domain_unexpectedvalue, entityType.Name, keyProperty, key, valueProperty, value));
    }

    /// <summary>
    /// Creates a new <see cref="DomainValidationException"/> thrown when the validation of an entity failed
    /// </summary>
    /// <param name="errors">An array containing the <see cref="Error"/>s that describe the validation failures</param>
    /// <returns>A new <see cref="DomainValidationException"/> thrown when the validation of an entity failed</returns>
    public static DomainValidationException ValidationFailed(params Error[] errors) => new(errors);
