    ...
    : DomainException
{
    ...
    public DomainNullReferenceException(string message) : base(message) { }
    ...
    public DomainNullReferenceException(string message, Exception innerException) : base(message, innerException) { }
