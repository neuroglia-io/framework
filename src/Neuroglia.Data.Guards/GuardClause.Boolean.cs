...
/// <summary>
/// Defines <see cref="bool"/>-related guard clauses
/// </summary>
public static class BooleanGuardClause
{
    ...
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<bool> WhenTrue(this IGuardClause<bool> guard, GuardException ex)
    {
        if (guard.Value) throw ex;
        return guard;
    }
    ...
    /// <param name="ex">The <see cref="Exception"/> to throw</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<bool> WhenFalse(this IGuardClause<bool> guard, GuardException ex)
    {
        if (!guard.Value) throw ex;
        return guard;
    }
