...
public static class DoubleGuardClause
{
    ...
    /// <summary>
    /// Throws when the value is lower or equal to a specified double
    /// </summary>
    /// <param name="guard">The extended <see cref="IGuardClause{T}"/></param>
    /// <param name="minimum">The minimum value allowed</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<double> WhenLowerOrEqualTo(this IGuardClause<double> guard, double minimum) => guard.WhenLowerOrEqualTo(minimum, StringFormatter.Format(GuardExceptionMessages.when_lower_than, minimum));
    ...
    /// <param name="message">The <see cref="Exception"/> message</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<double> WhenLowerOrEqualTo(this IGuardClause<double> guard, double minimum, string message) => guard.WhenLowerOrEqualTo(minimum, new GuardException(message, guard.ArgumentName));
    ...
    /// <param name="ex">The <see cref="Exception"/> to throw</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<double> WhenLowerOrEqualTo(this IGuardClause<double> guard, double minimum, GuardException ex)
    {
        if (guard.Value <= minimum) throw ex;
        return guard;
    }
    ...
    /// <summary>
    /// Throws when the value is higher or equal to a specified double
    /// </summary>
    /// <param name="guard">The extended <see cref="IGuardClause{T}"/></param>
    /// <param name="maximum">The maximum value allowed</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<double> WhenHigherOrEqualTo(this IGuardClause<double> guard, double maximum) => guard.WhenHigherOrEqualTo(maximum, StringFormatter.Format(GuardExceptionMessages.when_higher_than, maximum));
    ...
    /// <param name="message">The <see cref="Exception"/> message</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<double> WhenHigherOrEqualTo(this IGuardClause<double> guard, double maximum, string message) => guard.WhenHigherOrEqualTo(maximum, new GuardException(message, guard.ArgumentName));
    ...
    /// <param name="ex">The <see cref="Exception"/> to throw</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<double> WhenHigherOrEqualTo(this IGuardClause<double> guard, double maximum, GuardException ex)
    {
        if (guard.Value >= maximum) throw ex;
        return guard;
    }
