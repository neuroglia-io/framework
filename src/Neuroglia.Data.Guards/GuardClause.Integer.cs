...
public static class IntegerGuardClause
{
    ...
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<int> WhenNegative(this IGuardClause<int> guard, string message) => guard.WhenNegative(new GuardException(message));
    ...
    /// <param name="message">The <see cref="Exception"/> message</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<int> WhenPositive(this IGuardClause<int> guard, string message) => guard.WhenPositive(new GuardException(message));
    ...
    /// <param name="message">The <see cref="Exception"/> message</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<int> WhenLowerThan(this IGuardClause<int> guard, int minimum, string message) => guard.WhenLowerThan(minimum, new GuardException(message));
    ...
    /// <param name="message">The <see cref="Exception"/> message</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<int> WhenHigherThan(this IGuardClause<int> guard, int maximum, string message) => guard.WhenHigherThan(maximum, new GuardException(message));
    ...
    /// <param name="message">The <see cref="Exception"/> message</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<int> WhenWithinRange(this IGuardClause<int> guard, int minimum, int maximum, string message) => guard.WhenWithinRange(minimum, maximum, new GuardException(message));
    ...
    /// <param name="message">The <see cref="Exception"/> message</param>
    /// <returns>The configure <see cref="IGuardClause{T}"/></returns>
    public static IGuardClause<int> WhenNotWithinRange(this IGuardClause<int> guard, int minimum, int maximum, string message) => guard.WhenNotWithinRange(minimum, maximum, new GuardException(message));
